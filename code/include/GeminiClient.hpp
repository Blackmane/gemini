...
namespace gemini {
    ...
    public:
         ...
         * @return a pointer to the response, or throw an exception in case of failure.
         */
        static std::unique_ptr<Response> request(const std::string url, const std::string port);
        /**
